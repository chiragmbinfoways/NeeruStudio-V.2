            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item {{ (request()->is('jpanel/catalog*')) ? 'menu-open' : '' }}">
                            <a href="#" class="nav-link {{ (request()->is('jpanel/catalog*')) ? 'active' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('list.category') }}" class="nav-link {{ (request()->is('jpanel/catalog/category')) ? 'active' : '' }}">
                                        <i class="far fa-list-alt nav-icon"></i>
                                        <p>Category List</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('create.category') }}" class="nav-link {{ (request()->is('jpanel/catalog/category/add')) ? 'active' : '' }}">
                                        <i class="far fa-plus-square nav-icon"></i>
                                        <p>Category Add</p>
                                    </a>
                                </li>
                                @endif
                                @if(hasAnyOnePermission('brand'))
                                <li class="nav-item">
                                    <a href="{{ route('list.brands') }}" class="nav-link {{ (request()->is('jpanel/catalog/brands')) ? 'active' : '' }}">
                                        <i class="far fa-list-alt nav-icon"></i>
                                        <p>Brand List</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('create.brand') }}" class="nav-link {{ (request()->is('jpanel/catalog/brand/add')) ? 'active' : '' }}">
                                        <i class="far fa-plus-square nav-icon"></i>
                                        <p>Brand Add</p>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('list.attributes') }}" class="nav-link {{ (request()->is('jpanel/catalog/attribute')) ? 'active' : '' }}">
                                        <i class="far fa-list-alt nav-icon"></i>
                                        <p>Attribute List</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('create.attribute') }}" class="nav-link {{ (request()->is('jpanel/catalog/attribute/add')) ? 'active' : '' }}">
                                        <i class="far fa-plus-square nav-icon"></i>
                                        <p>Attribute Add</p>
                                    </a>
                                </li>
                        ...
                        @endif
                        @if(hasAnyOnePermission('customers','2'))
                        <li class="nav-item {{ (request()->is('jpanel/customers*')) ? 'menu-open' : '' }}">
                            <a href="#" class="nav-link {{ (request()->is('jpanel/customers*')) ? 'active' : '' }}">
                                <i class="nav-icon fas fa-user-tie"></i>
                                <p>
                                    Customer
                                    <i class="right fas fa-angle-left"></i>
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('list.customers') }}" class="nav-link {{ (request()->is('jpanel/Customers')) ? 'active' : '' }}">
                                        <i class="far fa-list-alt nav-icon"></i>
                                        <p>Customer List</p>
                                    </a>
                                </li>
                                ...
                                @if(hasPermission('customers','2'))
                                <li class="nav-item">
                                    <a href="{{ route('create.customers') }}" class="nav-link {{ (request()->is('jpanel/customers/add')) ? 'active' : '' }}">
                                        <i class="far fa-plus-square nav-icon"></i>
                                        <p>Customer Add</p>
                                    </a>
                                </li>
                        ...
                        @endif
                        @if(hasAnyOnePermission('order','2'))
                        <li class="nav-item {{ (request()->is('jpanel/order*')) ? 'menu-open' : '' }}">
                            <a href="#" class="nav-link {{ (request()->is('jpanel/order*')) ? 'active' : '' }}">
                                <i class="nav-icon fas fa-user-tie"></i>
                                <p>
                                    Order
                                    <i class="right fas fa-angle-left"></i>
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('list.order') }}" class="nav-link {{ (request()->is('jpanel/order')) ? 'active' : '' }}">
                                        <i class="far fa-list-alt nav-icon"></i>
                                        <p>Orders List</p>
                                    </a>
                                </li>
                                ...
                                @if(hasPermission('order','2'))
                                <li class="nav-item">
                                    <a href="{{ route('create.order') }}" class="nav-link {{ (request()->is('jpanel/order/create')) ? 'active' : '' }}">
                                        <i class="far fa-plus-square nav-icon"></i>
                                        <p>Add order</p>
                                    </a>
                                </li>
