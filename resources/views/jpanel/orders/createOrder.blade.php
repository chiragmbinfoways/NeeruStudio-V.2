                                    ...
                                    <table class="table" id="item">
                                        <thead class="bg-dark">
                                            <tr class="item">
                                                ...
                                                <th scope="col-md-3">Rate (₹)</th>
                                                <th scope="col-md-2">Quantity(nos)</th>
                                        ...
                                        <div id="blowse" >
                                            <div class="form-row">
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm " id="Shoulder"
                                                        name="b_shoulder" placeholder="Enter Shoulder" value="">
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label for="name">Length (લંબાઈ)</label>
                                                    <input type="text" class="form-control form-control-sm " id="length"
                                                        name="b_length" placeholder="Enter Length" value="">
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label for="name">Chest (છાતી)</label>
                                                    <input type="text" class="form-control form-control-sm " id="chest"
                                                        name="b_chest" placeholder="Enter Chest" value="">
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm " id="chest"
                                                        name="b_waist" placeholder="Enter Waist" value="">
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label for="name">Chest Up (છાતી અપ)</label>
                                                    <input type="text" class="form-control form-control-sm " id="chest"
                                                        name="b_chest_up" placeholder="Enter Chest Up" value="">
                                                </div>
                                                <div class="col-md-3 mb-3">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm " id="length"
                                                        name="b_magismory" placeholder="Enter Length" value="">
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col-md-3 mb-3">
                                                    <label for="name">Front Neck (ગળું આ)</label>
                                                    <input type="text" class="form-control form-control-sm " id="frontNeck"
                                                        name="b_front_neck" placeholder="Enter Front" value="">
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label for="name">Back Neck (ગળું પા)</label>
                                                    <input type="text" class="form-control form-control-sm " id="backNeck"
                                                        name="b_back_neck" placeholder="Enter Back" value="">
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label for="name">Other(અન્ય)</label>
                                                    <input type="text" class="form-control form-control-sm " id="other"
                                                        name="b_other" placeholder="Enter other measurement" value="">
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col-md-3 mb-3">
